...
const DataTableExpandableBalance = (props) => {
    const {
...
DataTableExpandableBalance.propTypes = {
...
DataTableExpandableBalance.defaultProps = {
...
export default DataTableExpandableBalance
