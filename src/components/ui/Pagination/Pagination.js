...
const Pagination = (props) => {
    const { className, currentPage, displayTotal, onChange, limit, total } =
        props

    const [paginationTotal, setPaginationTotal] = useState(total)
    const [internalPageSize, setInternalPageSize] = useState(limit)
    ...
    useEffect(() => {
        ...
        if (limit !== internalPageSize) {
            setInternalPageSize(limit)
        }
